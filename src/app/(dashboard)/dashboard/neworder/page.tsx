...
return (
  ...
  <div className="grid grid-cols-2 gap-4">
    <div>
      ...
      <div className="bg-gray-800 rounded-xl px-4 py-3 text-center font-semibold border border-gray-700">
        PayPal
      </div>
    </div>
    <div>
      ...
      <select
        className="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white font-semibold text-center appearance-none"
      >
        <option value="USDT" className="flex items-center gap-2">
          USDT
        </option>
        <option value="BS" className="flex items-center gap-2">
          Bs (Bolívares)
        </option>
      </select>
    </div>
